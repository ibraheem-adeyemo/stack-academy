    ...
    <div className='shadow-2xl rounded-2xl overflow-hidden'>
      ...
      <div className='border-b-2 pb-5 border-active-blue-100 mx-5'>
        ...
        <div className='relative'>
            <Link href={urls.register} className='border block bg-active-red-700 shadow-xl hover:bg-active-red-500 text-white cursor-pointer font-semibold text-xl my-6 px-10 py-4 tracking-wide rounded-4xl'>Register for the next cohort now</Link>
        </div>
      </div>
      <div className='pt-5 mb-10 mx-10'>
        <h4 className='text-center font-bold text-2xl mb-5'> This course includes:</h4>
