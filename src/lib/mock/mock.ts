export const courses = [
  {
    ...
    description:
      "Learn React, Tailwind CSS, and modern web dev best practices.",
    price: "₦175,000",
    link: "/frontend",
  },
  {
    ...
    description: "Master Node.js, Express, databases, and RESTful APIs.",
    price: "₦175,000",
    link: "/backend",
  },
  {
    image: "/desola-lanre-ologun-kwzWjTnDPLk-unsplash.jpg",
    title: "Advance Backend Development",
    description: "Master Node.js, Express, databases, and RESTful APIs.",
    price: "₦280,000",
    link: "/backend",
  },
...
export const benefits = [
  {
    title: "Supportive, Expert Instructors",
    content:
      "At TopStak, you're not just learning from a screen—you’re guided by experienced software engineers who care about your growth and are always ready to support you.",
  },
  {
    title: "Hands-On, Project-Based Learning",
    content:
      "We don’t just teach theory. You’ll build real-world projects that simulate what developers do in startups and tech companies, preparing you for the job market from day one.",
  },
  {
    title: "Flexible Learning Options",
    content:
      "Whether you prefer to learn online or on-site, full-time or part-time, TopStak offers flexible paths that fit your schedule without compromising on quality.",
  },
  {
    title: "Career-Focused Curriculum",
    content:
      "Our curriculum is designed with employers in mind—covering the most in-demand technologies, tools, and workflows that companies are hiring for right now.",
  },
  {
    title: "Community & Mentorship",
    content:
      "You're never alone at TopStak. Join a vibrant community of learners, mentors, and alumni who share knowledge, support each other, and grow together.",
  },
  {
    title: "Job Readiness & Placement Support",
    content:
      "From resume reviews to mock interviews and direct job referrals, we’re committed to helping you launch or switch to a successful tech career—not just complete a course.",
  },
];
